...
<%@ page import="dao.ClubPadelDao" %>
<%@ page import="domain.ClubPadel" %>
    ...
    <main class="container">
        <section class="mb-5">
            ...
            <%
                ...
                clubPadel = clubPadelDao.findByName(nombreClub);
                */
                try{
                    List<ClubPadel> listClubPadel = clubPadelDao.showAll();
                    for (ClubPadel clubPadel : listClubPadel){
            %>
            <div class="row mb-1">
                <div class="col-3 col-md-2 text-truncate"><%= clubPadel.getNombre_club() %></div>
                <div class="col-3 col-md-2 text-truncate"><%= clubPadel.getDireccion() %></div>
                <div class="col-3 col-md-2 text-truncate"><%= clubPadel.getTelefono() %></div>
                <div class="col-3 col-md-2 text-truncate"><%= clubPadel.getWeb() %></div>
                <div class="col-3 col-md-2 text-truncate"><%= clubPadel.getFederacion() %></div>
                <div class="col-12 col-md-2 ms-md-2 text-truncate mt-2 d-flex justify-content-center">
                    <button type="button" class="btn btn-primary me-3">
                        <a href="view-club.jsp?nombreClub=<%=clubPadel.getNombre_club()%>">
                    ...
                    <button type="button" class="btn btn-primary me-3">
                        <a href="edit-book.jsp?isbn=<%=book.getIsbn()%>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-pen" viewBox="0 0 16 16">
                            <path
                                d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z">
                    ...
                    <button type="submit" class="btn btn-outline-danger">
                        <a href="delete-book?isbn=<%= book.getIsbn() %>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <section class="border border-1 p-5 rounded">
            <form id="add">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input name="isbn" type="text" class="form-control w-25" id="isbn" />
                    </div>
                </div>
                <div class="row mb-3">
