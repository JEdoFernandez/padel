...
<main class="container">
    <header>
        <form action="buscar-club-padel.jsp">
            <input type="text" name="federacion" id="federacion" placeholder="Buscar por federacion"/>
            <input type="text" name="nombre" id="nombre" placeholder="Buscar por nombre"/>
            <button type="submit">Buscar</button>
        </form>
        <a href="add-club-padel.jsp">Registrar nuevo club</a>
